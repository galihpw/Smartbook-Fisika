...
public class Foto2Soal1 extends Fragment {
    ...
    @BindView(R.id.jawab2soal11)
    ImageView jawab2soal11;

    @BindView(R.id.jawab2soal12)
    ImageView jawab2soal12;

    @BindView(R.id.jawab2soal13)
    ImageView jawab2soal13;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        final View rootView = inflater.inflate(R.layout.foto2_soal1, container, false);
