...
public class FotoSoal3 extends Fragment {
    ...
    @BindView(R.id.jawabsoal3)
    ImageView jawabsoal3;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        jawabsoal3.setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                switch (value[item]) {
                    ...
                    case "Remove Profile Photo":
                        ...
                        jawabsoal3.setImageResource(R.drawable.bgmateri1);
                        break;
                }
    ...
    private void onCaptureImageResult(Intent data) {
        ...
        jawabsoal3.setImageBitmap(bitmap);
    }
