...
public class TabSoal19 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.tab_soal19, container, false);
        ...
        rG.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, @IdRes int i) {
                ...
                if(rB.getText().equals("berbanding terbalik dengan beda potensial antara kedua kepingnya.")){
        ...
        hintButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(countHint == 1) {
                    alertDialog.setMessage("Maaf tidak ada hints");
                }
