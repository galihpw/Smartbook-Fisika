...
public class TabSoal16 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.tab_soal16, container, false);
        ...
        rG.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, @IdRes int i) {
                ...
                if(rB.getText().equals("Arah medan listrik menjauhi q bila q positif dan menuju q bila q negatif.")){
        ...
        hintButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(countHint == 1) {
                    image.setImageResource(R.drawable.soalhint161);
                }else if(countHint == 2){
                    image.setImageResource(R.drawable.soalhint162);
                }
