...
public class TabSoal26 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.tab_soal26, container, false);
        ...
        rG.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, @IdRes int i) {
                ...
                if(rB.getText().equals("E berbanding terbalik dengan kuadrat r.")){
        ...
        hintButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(countHint == 1) {
                    alertDialog.setMessage("Pelajari tabel pada soal no 26, dan cari keterkaitan antara E dan r");
                }
