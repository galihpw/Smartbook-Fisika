...
public class TabSoal29 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.tab_soal29, container, false);
        ...
        rG.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, @IdRes int i) {
                ...
                if(rB.getText().equals("makin besar apabila luas kedua keping diperbesar dan diperkecil jarak antar  kedua keping.")){
